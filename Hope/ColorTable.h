...
#define COLOR_LIME		glm::vec3(0.0f, 1.0f, 0.0f)
...
#define COLOR_SILVER	glm::vec3(0.75294f, 0.75294f, 0.75294f)
#define COLOR_GRAY		glm::vec3(0.5f, 0.5f, 0.5f)
#define COLOR_MAROON	glm::vec3(0.5f, 0.0f, 0.0f)
#define COLOR_OLIVE		glm::vec3(0.5f, 0.5f, 0.0f)
